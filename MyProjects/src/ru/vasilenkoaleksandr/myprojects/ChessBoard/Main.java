package ru.vasilenkoaleksandr.myprojects.ChessBoard;


import ru.vasilenkoaleksandr.myprojects.ChessBoard.Logic.ChessBoard;
import ru.vasilenkoaleksandr.myprojects.ChessBoard.Logic.ChessNotFoundExeption;
import ru.vasilenkoaleksandr.myprojects.ChessBoard.Logic.FactoryShapeChees;
import ru.vasilenkoaleksandr.myprojects.ChessBoard.Logic.ShapeChess;
import ru.vasilenkoaleksandr.myprojects.ChessBoard.graffic.GrafficChess;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GrafficChess gch = GrafficChess.getInstance();
...
//        } catch (ChessNotFoundExeption exeption) {
